...
@Component({ selector: 'ac-select', changeDetection: ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>', inputs: ['disabled', 'error', 'fetch', 'helperText', 'label', 'loading', 'multiple', 'name', 'noResultsLabel', 'options', 'required', 'searchable', 'size', 'validator', 'validity', 'value'] })
...
proxyInputs(AcSelect, ['disabled', 'error', 'fetch', 'helperText', 'label', 'loading', 'multiple', 'name', 'noResultsLabel', 'options', 'required', 'searchable', 'size', 'validator', 'validity', 'value']);
